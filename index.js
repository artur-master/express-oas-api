...
For more information, see https://github.com/artur-master/express-oas-api#Advanced-usage-recommended
`;
      ...
      if (firstResponseProcessing || specOutputPath && ts - lastRecordTime > writeIntervalMs) {
        ...
        fs.writeFile(specOutputPath, JSON.stringify(spec, null, 2), 'utf8', err => {
          ...
          if (err) {
			 ...
			 * See https://github.com/artur-master/express-oas-api/pull/39#discussion_r340026645
			 */
 ...
 * https://github.com/artur-master/express-oas-api/issues/35
 *
 */
/**
